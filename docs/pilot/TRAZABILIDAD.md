...
| PIL-RF-12 | Calcular distribución (CP-SAT v1) | Implementado / ampliación adelantada | [ADR-023](../adr/ADR-023-motor-cpsat-dos-fases-mesa-y-asiento.md) | [`cp-sat-distribution.engine.ts`](../../apps/api/src/distribution/domain/cp-sat-distribution.engine.ts) | Specs dominio + E2E API (`DISTRIBUTION_ENGINE=v1`) + [`smoke-cpsat-engine.cjs`](../../apps/api/scripts/smoke-cpsat-engine.cjs) | Default prod y e2e; `test:e2e` con `--experimental-vm-modules` |
| PIL-RF-13 | Motor v0 (fallback) | Implementado con persistencia backend | DECISION-002 motor v0 | [`motor-v0.strategy.ts`](../../apps/api/src/distribution/domain/motor-v0.strategy.ts) | [`distribution.e2e-spec.ts`](../../apps/api/test/distribution.e2e-spec.ts) con `DISTRIBUTION_ENGINE=v0` | Fallback; e2e no fuerzan v0 |
